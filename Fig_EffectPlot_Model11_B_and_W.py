...
# FUAName_5E55E6=[]
# FUAName_5E615E6=[]
# NO2AveSatellite_5E45E5=[]
# NO2AveSatellite_5E55E6=[]
# NO2AveSatellite_5E615E6=[]
#===============================================================================
...
#         NO2AveSatellite_5E45E5.append(NO2AveSatellite[i])
...
#         NO2AveSatellite_5E55E6.append(NO2AveSatellite[i])
...
#         NO2AveSatellite_5E615E6.append(NO2AveSatellite[i])
...
for i in range(len(logDis)):
    a=-0.1823*logDis[i]+0.2161*(math.log(100000,10))+1.2004
...
for j in range(len(logDis)):
    b=-0.1823*logDis[j]+0.2161*(math.log(1000000,10))+1.2004
...
for k in range(len(logDis)):
    c=-0.1823*logDis[k]+0.2161*(math.log(10000000,10))+1.2004
...
#===============================================================================
# #uncomment to see original data points (a portion)
# ax.scatter(Dist_5E45E5, NO2AveSatellite_5E45E5,color='green',s=5)
# ax.scatter(Dist_5E55E6, NO2AveSatellite_5E55E6,color='blue',s=5)
# ax.scatter(Dist_5E615E6, NO2AveSatellite_5E615E6,color='red',s=5)
#===============================================================================
...
gray_patch = mpatches.Patch(color='silver', alpha=0.4,label='95% confidence interval')
