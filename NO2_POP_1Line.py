...
xls = pd.ExcelFile('X://ps-meanno2.xlsx')
df1 = pd.read_excel(xls,'ps-meanno2')
popSize=df1.iloc[0:41,4].tolist() 
meanNO2=df1.iloc[0:41,5].tolist()
sourceType=df1.iloc[0:41,6].tolist()
